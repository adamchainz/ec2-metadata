...
def test_custom_session(em_requests_mock):
    em = EC2Metadata(session=requests.Session())
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/ami-id", text="ami-12345678"
    )
    assert em.ami_id == "ami-12345678"


def test_ipv4(requests_mock):
    em = EC2Metadata(ipv4=True)
    requests_mock.put(
...
def test_ami_id_cached(em_requests_mock):
    ...
    ec2_metadata.ami_id
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/ami-id", status_code=500
    )
...
def test_ami_launch_index(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/ami-launch-index", text="0"
    )
...
def test_ami_manifest_path(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/ami-manifest-path", text="(unknown)"
    )
...
def test_availability_zone_id(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/placement/availability-zone-id",
        text="use1-az6",
    )
...
def test_iam_info(em_requests_mock):
    em_requests_mock.get("http://[fd00:ec2::254]/latest/meta-data/iam/info", text="{}")
    assert ec2_metadata.iam_info == {}


def test_iam_info_none(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/iam/info", status_code=404
    )
...
def test_iam_info_unexpected(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/iam/info", status_code=500
    )
    with pytest.raises(requests.exceptions.HTTPError):
...
def test_instance_action(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/instance-action", text="none"
    )
...
def test_instance_id(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/instance-id", text="i-12345678"
    )
...
def test_instance_profile_arn(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/iam/info",
...
def test_instance_type(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/instance-type", text="t2.nano"
    )
...
def test_kernel_id(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/kernel-id", text="aki-dc9ed9af"
    )
...
def test_kernel_id_none(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/kernel-id", status_code=404
    )
...
def test_mac(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/mac", text=example_mac
    )
...
def test_private_hostname(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/local-hostname",
...
def test_private_ipv4(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/local-ipv4", text="172.30.0.0"
    )
...
def test_public_hostname(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/public-hostname",
...
def test_public_hostname_none(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/public-hostname", status_code=404
    )
...
def test_public_ipv4(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/public-ipv4", text="1.2.3.4"
    )
...
def test_public_ipv4_none(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/public-ipv4", status_code=404
    )
...
def test_reservation_id(em_requests_mock):
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/reservation-id",
...
def test_security_groups_single(em_requests_mock):
    ...
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/security-groups",
...
def test_security_groups_emptystring(em_requests_mock):
    ...
    em_requests_mock.get(
        "http://[fd00:ec2::254]/latest/meta-data/security-groups", text=""
    )
    assert ec2_metadata.security_groups == []


def test_user_data_none(em_requests_mock):
    em_requests_mock.get("http://[fd00:ec2::254]/latest/user-data/", status_code=404)
    assert ec2_metadata.user_data is None


def test_user_data_something(em_requests_mock):
    em_requests_mock.get("http://[fd00:ec2::254]/latest/user-data/", content=b"foobar")
